  ...
  return (
    <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-4">
      ...
      <select
        ...
        name="location"
        value={sizePerPage}
        onChange={(e) => onSizePerPageChange(e.target.value, currentPage)}
        className="mt-1 mr-2 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-red-300 focus:border-red-300 sm:text-sm rounded-md"
      >
        {sizePerPageList.map((num, i) => (
