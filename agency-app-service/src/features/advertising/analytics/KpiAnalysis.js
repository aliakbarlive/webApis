...
const KpiAnalysis = ({ startDate, endDate, accountId, marketplace }) => {
  ...
  useEffect(() => {
    axios
      .get('/advertising/targetings/distributions', {
        params: { attribute, startDate, endDate, accountId, marketplace },
      })
  ...
  }, [startDate, endDate, accountId, marketplace, attribute]);
