  ...
  return loading && showLoading ? (
    ...
    >
      <div className="text-center pb-5">
        <p className="font-normal text-sm text-gray-500">Cost per conversion</p>
      ...
      <div className="border-solid border-gray-300 border-t pt-2 mt-2 text-gray-500">
        ...
        <div className="flex flex-row justify-around">
          ...
          <p className="font-normal text-xs">{currencyFormatter(orders)}</p>
        </div>
      </div>
    </div>
  );
...
export default CostPerConversion;
