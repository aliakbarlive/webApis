...
import { SPONSORED_BRANDS_CUSTOM_ATTRIBUTES } from './utils/constants';
...
const SponsoredBrands = ({ account, marketplace, query }) => {
  ...
  const tabs = [
    {
      ...
      component: Campaigns,
      href: `/accounts/${account.accountId}/advertising/brands/campaigns`,
      path: `/accounts/${account.accountId}/advertising/brands/campaigns`,
    },
    {
      name: t(`Advertising.AdGroups`),
      component: AdGroups,
      href: `/accounts/${account.accountId}/advertising/brands/ad-groups`,
      path: `/accounts/${account.accountId}/advertising/brands/ad-groups`,
    },
    {
      name: t(`Advertising.Keywords`),
      component: Keywords,
      href: `/accounts/${account.accountId}/advertising/brands/keywords`,
      path: `/accounts/${account.accountId}/advertising/brands/keywords`,
    },
  ];
    ...
    <div className="mb-6">
      <div className="grid xl:grid-cols-2">
        <div id="statistics">
          ...
          <Statistics
            ...
            customAttributes={SPONSORED_BRANDS_CUSTOM_ATTRIBUTES}
      ...
      <Switch>
        <Route
          ...
          render={() => (
            <Redirect
              to={`/accounts/${account.accountId}/advertising/brands/campaigns${query}`}
            />
          )}
        />
