...
export const getNetProfitAsync = (selectedDates) => async (dispatch) => {
  try {
...
export const getNetRevenueAsync = (selectedDates) => async (dispatch) => {
  try {
    const breakdown = await axios({
      method: 'GET',
...
export const getTotalCostAsync = (selectedDates) => async (dispatch) => {
  try {
    const breakdown = await axios({
      method: 'GET',
...
export const getMarginAsync = (selectedDates) => async (dispatch) => {
  try {
    const breakdown = await axios({
      method: 'GET',
...
export const getRoiAsync = (selectedDates) => async (dispatch) => {
  try {
    const breakdown = await axios({
      method: 'GET',
