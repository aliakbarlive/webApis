...
const employees = [
  {
    ...
    lastName: 'Dummy',
    email: 'dummy.ppc.head@sellerinteractive.com',
    roleId: 30,
  },
  {
    firstName: 'Neil Garret',
    lastName: 'Sumagang',
    email: 'neil.sumagang@sellerinteractive.com',
    roleId: 17,
  },
  {
    firstName: 'Tammy Ann',
    lastName: 'Teodoro',
    email: 'tammy.teodoro@sellerinteractive.com',
    roleId: 18,
  },
  {
    firstName: 'Allen Dave',
    lastName: 'Tumbaga',
    email: 'allen.tumbaga@sellerinteractive.com',
    roleId: 18,
  },
  {
    firstName: 'Jimmy',
    lastName: 'Leonar Jr.',
    email: 'jimmy.leonar@sellerinteractive.com',
    roleId: 18,
  },
  {
    firstName: 'Neil Andre ',
    lastName: 'Paquingan',
    email: 'neil.paquingan@sellerinteractive.com',
    roleId: 18,
  },
  {
    firstName: 'Karen PPC',
    lastName: 'Chen',
    email: 'karen.chen.ppc@sellerinteractive.com',
    roleId: 17,
  },
];
