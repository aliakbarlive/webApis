...
module.exports = (sequelize, DataTypes) => {
  class AdvTargetRecord extends Model {
    /**
     * Helper method for defining associations.
     * This method is not a part of Sequelize lifecycle.
     * The `models/index` file will call this method automatically.
     */
    static associate({ AdvTarget }) {
  ...
  AdvTargetRecord.init(
    ...
    {
      sequelize,
      modelName: 'AdvTargetRecord',
      tableName: 'advTargetRecords',
      timestamps: false,
    }
  );
  return AdvTargetRecord;
};
