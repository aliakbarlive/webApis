...
const AdvTargeting = require('./advTargeting');

module.exports = (sequelize, DataTypes) => {
  class AdvTargetingRecord extends Model {
    /**
     * Helper method for defining associations.
     * This method is not a part of Sequelize lifecycle.
     * The `models/index` file will call this method automatically.
     */
    static associate({ AdvTargeting }) {
      this.belongsTo(AdvTargeting, {
        foreignKey: 'advTargetingId',
        constraints: false,
      });
    }
  }
  AdvTargetingRecord.init(
    {
      advTargetingId: {
    ...
    {
      sequelize,
      modelName: 'AdvTargetingRecord',
      tableName: 'advTargetingRecords',
      timestamps: false,
    }
  );
  return AdvTargetingRecord;
};
