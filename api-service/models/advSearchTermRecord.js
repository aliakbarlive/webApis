...
module.exports = (sequelize, DataTypes) => {
  class AdvSearchTermRecord extends Model {
    /**
     * Helper method for defining associations.
     * This method is not a part of Sequelize lifecycle.
     * The `models/index` file will call this method automatically.
     */
    static associate({ AdvSearchTerm }) {
      this.belongsTo(AdvSearchTerm, {
        foreignKey: 'advSearchTermId',
      });
    }
  }
  AdvSearchTermRecord.init(
    {
      advSearchTermId: {
    ...
    {
      sequelize,
      modelName: 'AdvSearchTermRecord',
      tableName: 'advSearchTermRecords',
      timestamps: false,
    }
  );
  return AdvSearchTermRecord;
};
