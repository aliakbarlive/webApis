...
module.exports = (sequelize, DataTypes) => {
  class AdvKeywordRecord extends Model {
    /**
     * Helper method for defining associations.
     * This method is not a part of Sequelize lifecycle.
     * The `models/index` file will call this method automatically.
     */
    static associate({ AdvKeyword }) {
  ...
  AdvKeywordRecord.init(
    ...
    {
      sequelize,
      modelName: 'AdvKeywordRecord',
      tableName: 'advKeywordRecords',
      timestamps: false,
    }
  );
  return AdvKeywordRecord;
};
