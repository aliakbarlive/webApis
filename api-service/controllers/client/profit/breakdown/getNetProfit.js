...
// @desc      Get Metrics
// @route     GET /api/v1/profit/breakdown/net-profit?startDate=2021-07-01&endDate=2021-07-31
// @access  Private
module.exports = asyncHandler(async (req, res, next) => {
  ...
  const netRevenue = parseFloat(
    parseFloat(sales).toFixed(2) + parseFloat(refunds).toFixed(2)
  );
  ...
  const totalCost = parseFloat(
    (totalCostItemFee + parseFloat(ppcSpend) + parseFloat(cogs)).toFixed(2)
  );
